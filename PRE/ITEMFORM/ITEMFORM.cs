      ...
      //  public static ITEMFORM instance;
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
                ...
                try
                {
                    ...
                    this.txt_category_id.SelectedValue = Convert.ToInt32( dataGridView1.Rows[e.RowIndex].Cells[8].Value.ToString());
                    this.txt_categories.Text = dataGridView1.Rows[e.RowIndex].Cells[3].Value.ToString();

                    this.txt_item_amount.Text = dataGridView1.Rows[e.RowIndex].Cells[7].Value.ToString();
                    this.txtqty.Text = dataGridView1.Rows[e.RowIndex].Cells[6].Value.ToString();
                    this.txt_item_weight.Text = dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString();
                    this.txt_item_carat.Text = dataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString();
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            try
            {
                ...
                if (msg.WParam.ToInt32() == (int)Keys.Enter)
                {
                    if (dataGridView1.SelectedRows.Count >= 1)
                    {
                        DialogResult result = MessageBox.Show("Are You Sure You Want To Modify ?\n\nItemcode : " + dataGridView1.SelectedRows[0].Cells[0].Value.ToString() + "\n\nItemName : " + dataGridView1.SelectedRows[0].Cells[1].Value.ToString() + "", BUS1.Config.ApplicationName, MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                        if (result == DialogResult.Yes)
                        {
                          

                            this.txt_item_code.Text = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
                            this.txt_item_name.Text = dataGridView1.SelectedRows[0].Cells[1].Value.ToString();
                            this.txt_category_id.SelectedValue = dataGridView1.SelectedRows[2].Cells[0].Value.ToString();
                            this.txt_categories.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();

                            this.txt_item_amount.Text = dataGridView1.SelectedRows[0].Cells[7].Value.ToString();
                            this.txtqty.Text = dataGridView1.SelectedRows[0].Cells[6].Value.ToString();
                            this.txt_item_weight.Text = dataGridView1.SelectedRows[0].Cells[5].Value.ToString();
                            this.txt_item_carat.Text = dataGridView1.SelectedRows[0].Cells[4].Value.ToString();
